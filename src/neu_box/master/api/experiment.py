...
from neu_box.master.services.db import Database
from neu_box.master.api.auth import login_required
from neu_box.master.paths import experiment_logs_dir, uploads_dir
...
# 图片上传大小限制 (默认 10MB)
UPLOAD_MAX_SIZE = env_int(
    "NEU_BOX_UPLOAD_MAX_SIZE",
    10 * 1024 * 1024,
    "upload_max_size",
)
# 允许的图片 MIME 类型
...
def upload_image():
    ...
    upload_dir = os.path.join(UPLOAD_DIR, month_dir)
    os.makedirs(upload_dir, exist_ok=True)
